...
const projects = [
  ...
  { categoria: "Converting", progetto: "Tagliaribobinatrice rotoli domestici – Serie Rotomac", descrizione: "Taglierina ribobinatrice dedicata a rotoli per uso domestico (alluminio, pellicola, carta forno).", dettagli: "Software di gestione realizzato internamente (serie Rotomac).", paese: "Italia", tagClass: "tag-converting" },
